...
export default function Register() {
  ...
  return (
    <AuthLayout tagline="Create recruiter account">
      <h2 className="text-2xl font-semibold tracking-tight text-mist-100">Get started</h2>
      <p className="mt-1.5 text-sm text-mist-400">Start discovering candidates from their code.</p>

      <form onSubmit={onSubmit} className="mt-8 space-y-4">
        <div>
          <label className="mb-1.5 block text-xs font-medium text-mist-300">Full name</label>
          <input
            required
            value={fullName}
      ...
      <p className="mt-6 text-center text-sm text-mist-400">
        ...
        <Link to="/login" className="font-medium text-verified-400 hover:text-verified-300">
          Sign in
        </Link>
      </p>
    </AuthLayout>
